...
public class CreateJudgeCommand implements Command {
    ...
    public CreateJudgeCommand(String email, String commentId, int like, int dislike, int report) {
        this.email = email;
    ...
    public boolean equals(Object o) {
        ...
        CreateJudgeCommand that = (CreateJudgeCommand) o;
