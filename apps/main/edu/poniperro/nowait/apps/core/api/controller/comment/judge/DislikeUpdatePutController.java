...
@RestController
public final class DislikeUpdatePutController extends ApiController {

    @Autowired
    private JwtTokenProvider jwtTokenProvider;

    public DislikeUpdatePutController(QueryBus queryBus, CommandBus commandBus) {
        super(queryBus, commandBus);
    }

    @PutMapping(path = "/comment/dislike/update")
